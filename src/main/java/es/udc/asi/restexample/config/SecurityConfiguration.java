...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http.csrf().disable().exceptionHandling()
      ...
      .authorizeRequests().antMatchers("/api/iniciar_sesion").permitAll()
      .antMatchers(HttpMethod.GET, "/api/elecciones/**").permitAll()
      .antMatchers(HttpMethod.GET, "/api/usuarios/**").permitAll()
      .antMatchers(HttpMethod.GET, "/api/titulaciones/**").permitAll()
      .antMatchers(HttpMethod.POST, "/api/elecciones/**").permitAll()
      .antMatchers(HttpMethod.POST, "/api/usuarios/**").permitAll()
      .antMatchers(HttpMethod.PUT, "/api/usuarios/**").permitAll()
      .antMatchers("/api/candidaturas/**").permitAll()
